...
True, ZIP codes with a higher percentage of minority residents tend to have more FAIR policies per 100 housing units, indicated by the positive coefficient for minority when correlating with policies at 0.014 at a statistically significant 95% confidence interval of [0.009, 0.018], as the interval does not contain 0.

#### **Part B:**

False, the evidence does not define any explicit interaction between the two variables as only the correlation between minority percentage and age is measured, there is no explicit interaction being checked.
...
False, when adding income to the regression model between FAIR policies and minority, the coefficient for minority does decrease, indicating a weaker correlation. Although, income does not "explain away" the association between minority percentage and FAIR policies as the coefficient for the minority percentage is still at a statistically significant 95% confidence interval of [0.004, 0.015], as the interval does not contain 0.

#### **Part E:**

True, there is a statistically significant coefficient estimate of 0.008 for the minority variable even after controlling for income, fire risk, and age. It is statistically significant as the 95% confidence interval does not contain 0, it is [0.003, 0.014].
